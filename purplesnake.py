...
BLUE     = (0, 0, 255)
YELLOW   = (255, 255, 0)
PURPLE   = (128, 0, 128)  # Traps are now purple
WHITE    = (255, 255, 255)
...
def get_safe_move(snake, fruit, traps):
    ...
    Returns the move that maximizes the free space available.
    """
    head = snake[0]
    candidate_moves = []
...
def main():
    ...
    pygame.display.set_caption("Self-Playing Snake Game with Purple Traps")
